  ...
  plugins: [
    [
      "docusaurus-plugin-openapi-docs",
      {
        ...
        config: {
          waifuApi: {
            // The OpenAPI spec is auto-generated by the .NET backend at /openapi/v1.json
            // Change this to a local path (e.g. "./static/openapi.json") if the API isn't publicly accessible
            specPath: "https://api.waifu.im/openapi/v1.json",
            outputDir: "docs/api",
            sidebarOptions: {
              groupPathsBy: "tag",
            },
