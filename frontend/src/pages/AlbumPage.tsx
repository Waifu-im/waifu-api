    ...
    return (
        <div className="flex h-full relative overflow-hidden">
            ...
            <div className="flex-1 flex flex-col relative min-w-0 overflow-hidden">
                ...
                {/* BUTTONS: Mobile (top-3) vs Desktop (top-22px) */}
                <div className="absolute top-3 right-3 md:top-[22px] md:right-6 z-50 flex items-center gap-2 bg-background/80 backdrop-blur-md p-2 rounded-xl border border-border shadow-sm">
                    <button
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar">
                    ...
                    <ImageGrid
                        ...
                        page={page}
                        totalPages={orderBy === ImageSort.RANDOM ? 1 : totalPages}
                        setPage={setPage}
